...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <h4 class="py-2 mb-1"><span class="text-muted fw-light">Company </span> List</h4>
    @if(session('success'))
    ...
    @endif
    <div class="mb-1">
        <a href="{{ route('admin.companies.create') }}" class="btn createbtn btn-primary">Create</a>
            ...
            table = $('#myTable').DataTable({
                ...
                columns: [{
...

                    {
                        render: function(data, type, full) {
                            if (full.logo)
                                return '<img height="50" width="100" src="' + appBaseUrl + '/' +
                                    full.logo + '" />';
                            else
                                return '<img alt="no" />';
                        }
                ...
                "columnDefs": [{
                    ...
                    "render": function(data, type, full) {
                        ...
                        return  '<a class="btn btn-info" href="" data-toggle="modal" data-name="' + full.name +'"  data-email="' + full.email +'" data-target="#exampleModalLong">More</a>'+

                        '<a class="btn btn-primary" href="{{ url('admin/companies') }}/' +
                            full.id +
                            '/edit">Edit</a>' +
